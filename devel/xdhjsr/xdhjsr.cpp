/*
	'xdhjsr.cpp' by Claude SIMON (http://zeusw.org/).

	'xdhjsr' is part of the Epeios framework.
...
entry___ xdhjsr::custom_item::attribute_name::OnEvent( "OnEvent", xdhjsr::custom_item::AttributeNames );
entry___ xdhjsr::custom_item::attribute_name::OnEvents( "OnEvents", xdhjsr::custom_item::AttributeNames );
