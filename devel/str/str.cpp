    ...
    namespace {
      namespace untemplated_ {
        ...
        bso::sBool Conversion(
          ...
          qRPN)
        {
          return Flow.GetNumber(Number, Base, sSLimits<signed long long int>(UpperLimit, LowerLimit), qRP);
        }
      }
...
{
  return StringConversion_(String, Begin, ErrP, Base, Limit.Value(), 0ULL);
}
...
{
  return StringConversion_(String, Begin, ErrP, Base, Limits.Upper(), Limits.Lower());
}
/*
