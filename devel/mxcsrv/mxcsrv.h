...
// MuXed Connections SeRVer

#ifndef MXCSRV__INC
# define MXCSRV__INC

# define MXCSRV_NAME		"MXCSRV"

# if defined( E_DEBUG ) && !defined( MXCSRV_NODBG )
#  define MXCSRV_DBG
# endif
