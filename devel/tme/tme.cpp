/*
	'tme.cpp' by Claude SIMON (http://zeusw.org/).

	'tme' is part of the Epeios framework.
...
class tmepersonnalization
{
public:
	tmepersonnalization( void )
	{
...
static tmepersonnalization Tutor;
