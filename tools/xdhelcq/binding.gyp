  ...
  [
   "OS=='win'",
   {
    "variables": {
     ...
     "dest": "<!(IF DEFINED Q37_EPEIOS (echo h:/bin) ELSE (echo <(module_path)))",
    },
   },
   {
    "variables": {
     ...
     "dest": "<!(if [ \"$Q37_EPEIOS\" != \"\" ]; then echo /home/csimon/bin; else echo <(module_path); fi)",
    },
   }
  ]
 ],
