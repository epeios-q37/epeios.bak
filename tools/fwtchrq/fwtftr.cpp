...
const char *fwtftr::GetLabel( version__ Version )
{
	switch ( Version ) {
	case v0_1:
		return "0.1";
...
version__ fwtftr::GetVersion( const str::string_ &Pattern )
{
...
const str::string_ &fwtftr::file_tree_::GetPath(
	drow__ Row,
...
static void Organize_(
	...
	itod_ &IToD,
	drows_set_ &Dirs,
	fwtftr::processing_observer__ &Observer )
{
qRH
...
void fwtftr::file_tree_hook_filenames___::Init(
