...
namespace {
  namespace label_ {
    namespace attribute {
      qCDEFC( Chromatic, "Chromatic" );
      qCDEFC( Diatonic, "Diatonic" );
      qCDEFC( Octave, "Octave" );
    }
  }
}
  ...
  xml::rWriter &Writer )
{
  ...
  Writer.PutAttribute(label_::attribute::Octave, bso::Convert( Pitch.Octave, Buffer));
  Writer.PutAttribute(label_::attribute::Diatonic, bso::Convert( GetDiatonicAbsolute_(Pitch), Buffer));
  Writer.PutAttribute(label_::attribute::Chromatic, bso::Convert( GetChromaticAbsolute_(Pitch), Buffer));
  ...
  if ( PreviousPitch.Name != pn_Undefined ) {
    ...
    Writer.PutAttribute(label_::attribute::Diatonic, bso::Convert( DiatonicDelta, Buffer));
    Writer.PutAttribute(label_::attribute::Chromatic, bso::Convert( ChromaticDelta, Buffer));
  ...
  sAltPitch &Pitch )
{
  ...
  while ( Continue ) {
    ...
    case xml::tAttribute:
      ...
      } else if ( Parser.AttributeName() == label_::attribute::Octave ) {
