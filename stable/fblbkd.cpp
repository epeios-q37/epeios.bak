/*
	'fblbkd' library by Claude SIMON (csimon at zeusw dot org)
	Requires the 'fblbkd' header file ('fblbkd.h').
...
//	$Id: fblbkd.cpp,v 1.16 2013/04/15 10:50:35 csimon Exp $
...
public:
	fblbkdtutor( void )
	: ttr_tutor( FBLBKD_NAME )
	{
#ifdef FBLBKD_DBG
		Version = FBLBKD_VERSION "\b\bD $";
#else
		Version = FBLBKD_VERSION;
#endif
		Owner = FBLBKD_OWNER;
		Date = "$Date: 2013/04/15 10:50:35 $";
	}
	virtual ~fblbkdtutor( void ){}
};
