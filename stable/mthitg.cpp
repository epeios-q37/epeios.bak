/*
	'mthitg' library by Claude SIMON (http://zeusw.org/intl/contact.html)
	Requires the 'mthitg' header file ('mthitg.h').
	...
	integer_ &Reste )
{
	...
	while( I-- )
	{
		Reste = Divide_( Reste, Den, Result ) * integer( 0x10000UL ) + integer( Num.Core( I ) );
