...
//	$Id: dvkbse.cpp,v 1.1 2012/12/04 16:05:43 csimon Exp $
...
public:
	dvkbsetutor( void )
	: ttr_tutor( DVKBSE_NAME )
	{
#ifdef DVKBSE_DBG
		Version = DVKBSE_VERSION "\b\bD $";
#else
		Version = DVKBSE_VERSION;
#endif
		Owner = DVKBSE_OWNER;
		Date = "$Date: 2012/12/04 16:05:43 $";
	}
	virtual ~dvkbsetutor( void ){}
};
...
class dvkbsepersonnalization
: public dvkbsetutor
{
public:
	dvkbsepersonnalization( void )
	{
...
static dvkbsepersonnalization Tutor;

ttr_tutor &DVKBSETutor = Tutor;
