...
#define SHA1_COMPILATION_

#include "sha1.h"

// Code from 100% public domain code by Steve Reid <steve@edmweb.com> with modifications based on work by Peter Gutmann as posted to sci.crypt in message <30ajo5$oe8@ccu2.auckland.ac.nz>.
...
static void SHAFinal(BYTE *output, SHA_CTX *);
    ...
    str::dString &Hash )
{
    ...
    while ( !Flow.EndOfFlow() ) {
        ...
        SHAUpdate(&Context, (BYTE *)Buffer, Amount);
    }
