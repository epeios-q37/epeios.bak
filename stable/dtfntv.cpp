/*
	'dtfntv' library by Claude SIMON (http://zeusw.org/intl/contact.html)
	Requires the 'dtfntv' header file ('dtfntv.h').
	Copyright (C) 2003 Claude SIMON (http://zeusw.org/intl/contact.html).
