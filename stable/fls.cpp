/*
	'fls' library by Claude SIMON (csimon at zeusw dot org)
	Requires the 'fls' header file ('fls.h').
...
//	$Id: fls.cpp,v 1.11 2013/04/26 14:43:41 csimon Exp $
...
public:
	...
	{
#ifdef FLS_DBG
		Version = FLS_VERSION "\b\bD $";
#else
		Version = FLS_VERSION;
#endif
		Owner = FLS_OWNER;
		Date = "$Date: 2013/04/26 14:43:41 $";
	}
	virtual ~flstutor( void ){}
};
